...
export default function BoardPageLoading() {
  return (
    <section className="relative isolate -mx-3 -my-3 flex h-[calc(100dvh-var(--app-header-height))] items-center justify-center overflow-hidden bg-[#070b18] pb-20 sm:-mx-5 lg:-mx-6 md:pb-24">
